...
function deserializeFromBSON (rawData) {
 ...
 */
function deserializeFromJSON (rawData) {
...
var serialize = serializeToBSON;
var deserialize = deserializeFromBSON;
...
function Document(db, raw)
{
  ...
  else if (typeof(raw) === "string") raw = deserializeFromJSON(raw);
  else if (raw instanceof Buffer) raw = deserializeFromBSON(raw);
